...
public static class TextWriterExt
{
    ...
    public static void WriteStartColor(this TextWriter textWriter, ConsoleColor? background, ConsoleColor? foreground)
    {
    ...
    public static void WriteEndColor(this TextWriter textWriter)
    {
